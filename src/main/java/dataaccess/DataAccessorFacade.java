...
import businessmodels.BookCopy;
import businessmodels.CheckoutRecord;
import businessmodels.LibraryMember;


public class DataAccessorFacade implements DataAccessor {

	private static DataAccessorFacade instance = new DataAccessorFacade();
	...
	private DataAccessorFacade() {}

	public static DataAccessorFacade getInstance() {
		return instance;
	}
	...
	public LibraryMember getMember(String memberId) {
		HashMap<String, LibraryMember> mes = readMemberMap();
		LibraryMember libraryMember = mes.get(memberId);
