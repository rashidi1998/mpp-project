...
public class CheckoutRecord extends javax.swing.JPanel implements Initializable {
    ...
    public CheckoutRecord() {
        checkoutRecordMemberId =AuthenticationManager.INSTANCE.getUser().getMemberId();
        initComponents();
    }
    ...
    public DefaultTableModel initTable() {
        ...
        business.CheckoutRecord checkoutRecord = controller.getCheckoutRecord(
    ...
    public void onPanelVisible() {
        memberDetail.setText("Checkout Record for: " + AuthenticationManager.INSTANCE.getUser().getFirstName());
    };
